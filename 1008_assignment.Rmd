...
(2) Reformat this data frame to obtain the height into one single column and the time of the measurement as a factor with two levels. You save this data frame as the first element of a list named my.experiment.
```{r }
